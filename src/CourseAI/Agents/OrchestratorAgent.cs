...
namespace CourseAI.Agents
{
    public class OrchestratorAgent : IOrchestratorAgent
    {
        ...
        public string SystemMessage => """
            ...
            AVAILABLE TOOLS:
            - **PlannerAgent**: Gathers user information and builds complete LearningProfile
            ...
            DECISION LOGIC:
            - If learning profile is incomplete → Use PlannerAgent
            - If learning profile is complete but no roadmap exists → Use StructuringAgent
        ...
        public OrchestratorAgent(
            ...
            LearningProfileToolsService learningProfileToolsService,
            IAgentStatusService statusService)
        {
            ...
            // Add LearningProfile tools (minimal - only summary and status check)
            orchestratorTools.AddRange(_learningProfileToolsService.GetOrchestratorTools());
