...
*   **Elements:**
    **Hierarchical/Modular Display:** The roadmap should be presented as a clear, collapsible structure (Modules -> Topics -> Resources/Concepts).
        *   Each `Module` and `Topic` should have a title and description.
        *   Each `Topic` contains both **Learning Resources** (e.g., books, articles) and actionable **Goals/Concepts** (e.g., "Build a login form").
        *   `Resources` should have links and brief descriptions.
        *   `Concepts` should be presented as a checklist of tasks to complete.
