...
*   **Elements:**
    **Hierarchical/Modular Display:** The roadmap should be presented as a clear, collapsible structure (Modules -> Topics -> Resources/Concepts).
        ...
        *   **Confidence Score:** Each module and topic will display a confidence score (e.g., as a percentage or progress bar) to reflect the user's self-assessed understanding.
    *   **Interactive Controls for Refinement:**
        *   **"Quiz Me" Button:** A button on each topic to trigger a short quiz generated by an agent to assess and update the user's confidence score.
